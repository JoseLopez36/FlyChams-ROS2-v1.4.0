 ...
 * ════════════════════════════════════════════════════════════════
 */
class AgentPositioningExperimentNode : public BaseDiscovererNode
{
public: // Constructor/Destructor
    AgentPositioningExperimentNode(const std::string& node_name, const rclcpp::NodeOptions& options)
...
private: // Element management
    void onAddAgent(const ID& agent_id) override
    {
        ...
        agent_positionings_.insert({ agent_id,
            std::make_shared<AgentPositioningExperiment>(agent_id, node_, config_tools_, framework_tools_, topic_tools_, transform_tools_, positioning_cb_group) });
    }
...
private: // Components
    // Agent positioning experiments
    std::unordered_map<ID, AgentPositioningExperiment::SharedPtr> agent_positionings_;
};
...
int main(int argc, char** argv)
{
    ...
    // Create node
    auto node = std::make_shared<AgentPositioningExperimentNode>("agent_positioning_experiment_node", options);
    node->init();
